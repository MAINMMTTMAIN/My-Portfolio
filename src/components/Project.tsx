    ...
    return (
        <div className="projects-container" id="projects">
            ...
            <div className="projects-grid">
                ...
                <div className="project">
                    <a href="https://github.com/MAINMMTTMAIN/SystemPulse" target="_blank" rel="noreferrer">
                        <img src={mock17} className="zoom" alt="thumbnail" width="100%"/>
                    </a>
                    <a href="https://github.com/MAINMMTTMAIN/SystemPulse" target="_blank" rel="noreferrer">
                        <h2>SystemPulse</h2>
                    </a>
                ...
                <div className="project">
                    <a href="https://github.com/MAINMMTTMAIN/QR-Toolkit" target="_blank" rel="noreferrer">
